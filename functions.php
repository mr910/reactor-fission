<?php
/**
 * Reactor Fission Child Theme Functions
 *
 * @package Reactor
 * @author Brad Taylor (@mr910 / mr910.com)
 * @version 1.0.0
 * @since 1.0.0
...
add_action('after_setup_theme', 'reactor_fission_theme_setup', 11);

function reactor_fission_theme_setup() {
...
function reactor_fission_fa_scripts() {
	wp_enqueue_style( 'style-name', '//netdna.bootstrapcdn.com/font-awesome/4.0.3/css/font-awesome.css');
}
add_action('wp_enqueue_scripts', 'reactor_fission_fa_scripts');
?>